  ...
  return (
    <div className="auth-container">
      <div className="auth-card">
        ...
        <p className="auth-subtitle">Login to access your indexed repositories.</p>
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <button type="submit" className="btn-primary auth-submit" disabled={loading || !username}>
            {loading ? 'Logging in...' : <><Zap size={14} /> Login</>}
          </button>
        </form>
